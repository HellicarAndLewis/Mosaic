/*
  ...
  ----------------------------------------
    ...
    ./Polaroid -x 55 -y 62 -f ./background.png -r 0.0 -g 0.0 -b 0.0 -n "roxlu" -s 60 -t 578 -w 28 -a 458 -c ./polaroid_overlay_big.png

    
  Create the small version of the polaroid
  ----------------------------------------

   ./Polaroid -x 10 -y 10 -f ./background.png -r 0.0 -g 0.0 -b 0.0 -n "roxlu" -s 10 -t 190 -w 18 -a 180 -c ./polaroid_overlay_small.png
